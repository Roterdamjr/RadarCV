...
from funcoes_ai_pdf import fn_busca_job, fn_busca_resumo, fn_busca_opiniao, fn_gerar_score
...
print('========================================================')
prompt = fn_busca_opiniao(fn_busca_conteudo_curriculo(arq_curriculo), fn_busca_job())
