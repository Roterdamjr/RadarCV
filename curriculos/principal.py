...
prompt = fn_busca_resumo('CV Pedro Argento.pdf')
...
print('========================================================')
prompt = fn_busca_opniao(fn_busca_curriculo('CV Pedro Argento.pdf'),fn_busca_job())
...
print('========================================================')
prompt = fn_gerar_score(fn_busca_curriculo('CV Pedro Argento.pdf'),fn_busca_job())
